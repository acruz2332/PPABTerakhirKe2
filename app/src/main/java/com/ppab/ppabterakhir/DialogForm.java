    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String nnama = tnama.getText().toString();
                String nmatkul = tmatkul.getText().toString();
                if (pilih.equals("Ubah")){
                    database.child("Mahasiswa").child(key).setValue(new ModelMahasiswa(nnama, nmatkul)).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
